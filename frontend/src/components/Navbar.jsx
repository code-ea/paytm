...
export const Navbar = () => {
  return (
    <nav className="bg-neutral-800 p-2 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        {/* Logo */}
        <h1 className="text-white text-lg font-bold">Paytm Clone</h1>

        {/* Nav Links */}
        <ul className="flex space-x-6">
          <li>
            <Link to="/about" className="text-white text-md font-bold hover:text-gray-200">
              About
            </Link>
          </li>
          <li>
            <Link to="/dashboard" className="text-white text-md font-bold hover:text-gray-200">
              Dashboard
            </Link>
          </li>
          ...
          <li className="relative group">
            <button className="text-white text-md font-bold hover:text-gray-200 focus:outline-none">
              Account
            </button>
